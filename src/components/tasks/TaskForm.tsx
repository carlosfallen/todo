...
const TaskForm: React.FC<TaskFormProps> = ({ onClose }) => {
  ...
  return (
    <form
      ...
      className="border border-neutral-300 rounded-lg bg-white shadow-md overflow-hidden focus-within:ring-2 focus-within:ring-primary-300 focus-within:border-primary-300"
    >
      <div className="p-3">
        <input
          ref={titleInputRef}
