  ...
  return (
    <div className="w-full max-w-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="displayName" className="block text-label-large text-on-surface mb-2">
            Nome (opcional)
          </label>
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-label-large text-on-surface mb-2">
            Confirmar senha
          </label>
          <div className="relative">
            <Lock size={20} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-on-surface-variant" />
        ...
        >
          {loading ? (
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-label-large">Criando conta...</span>
            </div>
          ) : (
            <span className="text-label-large">Criar conta</span>
          )}
        </button>
      </form>
